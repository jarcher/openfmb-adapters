...
@XmlType(name = "SolarControl", namespace = "http://openfmb.org/xsd/2015/12/openfmb/solarmodule", propOrder = {
    "isIslanded"
})
@XmlRootElement(name = "SolarControl", namespace = "http://openfmb.org/xsd/2015/12/openfmb/solarmodule")
