 ...
 * the License.
 */
package com.greenenergycorp.openfmb.mapping.mqtt.modbus;

import com.greenenergycorp.openfmb.mapping.adapter.*;
import com.greenenergycorp.openfmb.mapping.config.xml.ModbusMaster;
import com.greenenergycorp.openfmb.mapping.config.xml.OpenFMBModbus;
...
import com.greenenergycorp.openfmb.mapping.modbus.ModbusAdapterManager;
import com.greenenergycorp.openfmb.mapping.modbus.XmlConfigReader;
...
public class ModbusToMqttEntry {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        final XmlConfigReader.ModbusXmlMarshaller marshaller = XmlConfigReader.ModbusXmlMarshaller.build();

        // Parse the XML into a JAXB object.
        final OpenFMBModbus xmlConfig = marshaller.unmarshal(new FileInputStream(filename));
        ...
        // Update manager that takes data and pushes to OpenFMB adapters.
        ...
        final ModbusAdapterManager manager = new ModbusAdapterManager(adapterManager.getObserver());
        ...
        for (ModbusMaster masterXml : xmlConfig.getModbusMasters().getModbusMaster()) {
            final ControlHandlerMapping controlHandlerMapping = manager.addMaster(masterXml);
