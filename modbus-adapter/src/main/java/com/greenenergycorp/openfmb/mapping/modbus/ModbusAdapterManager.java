...
import com.greenenergycorp.openfmb.mapping.config.xml.ProtocolType;
...
public class ModbusAdapterManager {
     ...
     * @return Mapping of OpenFMB control IDs to control handlers.
     */
    public ControlHandlerMapping addMaster(final ModbusMaster xml) {
