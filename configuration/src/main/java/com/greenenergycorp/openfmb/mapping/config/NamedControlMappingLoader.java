...
import com.greenenergycorp.openfmb.mapping.config.xml.OpenFMBMapping;
        ...
        if (xml.getKeyControlMapping() != null && xml.getKeyControlMapping().getMapping() != null) {
            for (OpenFMBMapping.KeyControlMapping.Mapping mapping: xml.getKeyControlMapping().getMapping()) {
                ...
                if (mapping.getAdapterName() == null) {
                    throw new IllegalArgumentException("For " + commandName + ", control mapping must have adapter name");
                }
                final String adapterName = mapping.getAdapterName();

                if (mapping.getKey() == null) {
                    throw new IllegalArgumentException("For " + commandName + ", control mapping must have key");
                }
                ...
                if (mapping.getTransform() != null) {
                    transform = TransformXmlLoader.load(mapping.getTransform(), commandName);
                }
        ...
        if (xml.getEndDeviceControlMapping() != null && xml.getEndDeviceControlMapping().getMapping() != null) {
            for (OpenFMBMapping.EndDeviceControlMapping.Mapping mapping: xml.getEndDeviceControlMapping().getMapping()) {
                ...
                if (mapping.getAction() == null) {
                    throw new IllegalArgumentException("For " + commandName + ", control mapping must have action");
                }
                if (mapping.getType() == null) {
                    throw new IllegalArgumentException("For " + commandName + ", control mapping must have type");
                }
        ...
        if (xml.getSetPointControlMapping() != null && xml.getSetPointControlMapping().getMapping() != null) {
            for (OpenFMBMapping.SetPointControlMapping.Mapping mapping : xml.getSetPointControlMapping().getMapping()) {
                ...
                if (mapping.getControlType() == null) {
                    throw new IllegalArgumentException("For " + commandName + ", control mapping must have a control type");
                }
                if (mapping.getUnit() == null) {
                    throw new IllegalArgumentException("For " + commandName + ", control mapping lacking unit");
                }
                final UnitSymbolEnum unitSymbolEnum = XmlEnumConversions.convertFromXml(mapping.getUnit());
                if (unitSymbolEnum == null) {
                    throw new IllegalArgumentException("For " + commandName + ", control mapping couldn't convert unit");
                }
                if (mapping.getMultiplier() == null) {
                    throw new IllegalArgumentException("For " + commandName + ", control mapping was lacking unit multiplier");
                }
                ...
                if (unitMultiplierEnum == null) {
                    throw new IllegalArgumentException("For " + commandName + ", control mapping couldn't convert unit multiplier");
                }
                ...
                final Control.SetpointId setpointId = new Control.SetpointId(adapterName, mapping.getControlType(), unitSymbolEnum, unitMultiplierEnum);
