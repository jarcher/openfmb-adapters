...
import com.greenenergycorp.openfmb.mapping.config.xml.Transform;
...
public class TransformXmlLoader {
    ...
    public static MeasTransform load(final Transform xml, final String logId) {
            ...
            for (Object elem: xml.getElements()) {
                ...
                if (elem instanceof Transform.Scale) {
                    ...
                    if (entry.getMultiplier() != null || entry.getOffset() != null) {
                        ...
                        throw new IllegalArgumentException("For " + logId + ", scale transform must have one or both of multiplier or offset");
                    }
                    ...
                    if (entry.getCase() != null && entry.getCase().size() > 0) {
                        ...
                        if (entry.getDefaultBooleanValue() != null) {
                            ...
                            throw new IllegalArgumentException("For " + logId + ", match transform must include default value");
                        }
                        ...
                        for (Transform.Match.Case xmlCase: entry.getCase()) {
                            ...
                            if (xmlCase.getMatchBooleanValue() != null) {
                                ...
                                throw new IllegalArgumentException("For " + logId + ", match case must include a value to match");
                            }
                            ...
                            if (xmlCase.getToBooleanValue() != null) {
                                ...
                                throw new IllegalArgumentException("For " + logId + ", match case must include a result value");
                            }
                        ...
                        throw new IllegalArgumentException("For " + logId + ", match transform must include at least one case");
                    }
                    ...
                    if (entry.getValue() != null) {
                        ...
                        throw new IllegalArgumentException("For " + logId + ", GreaterThan transform must include value");
                    }
                    ...
                    if (entry.getValue() != null) {
                        ...
                        throw new IllegalArgumentException("For " + logId + ", GreaterThanOrEqual transform must include value");
                    }
                    ...
                    if (entry.getValue() != null) {
                        ...
                        throw new IllegalArgumentException("For " + logId + ", LessThan transform must include value");
                    }
                    ...
                    if (entry.getValue() != null) {
                        ...
                        throw new IllegalArgumentException("For " + logId + ", LessThanOrEqual transform must include value");
                    }
                } else {

                    throw new IllegalArgumentException("For " + logId + ", did not recognize transform step");
                }
            }
        }
