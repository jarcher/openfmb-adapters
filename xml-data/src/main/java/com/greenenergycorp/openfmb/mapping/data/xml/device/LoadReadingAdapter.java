...
import com.greenenergycorp.openfmb.xml.EnergyConsumer;
import com.greenenergycorp.openfmb.xml.LoadReadingProfile;
import com.greenenergycorp.openfmb.xml.Reading;

import java.util.Map;

public class LoadReadingAdapter implements JaxbObjectConverter {

    private final String messageId;
    private final EnergyConsumer deviceDescription;

    public LoadReadingAdapter(String messageId, EnergyConsumer deviceDescription) {
    ...
    public Object convert(Map<ReadingId, MeasValue> readingValues, Map<String, MeasValue> keyValues) throws Exception {
        if (readingValues != null && !readingValues.isEmpty()) {
            ...
            module.setEnergyConsumer(deviceDescription);;
