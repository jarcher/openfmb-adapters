...
/**
 * Used to map reading and key values to JAXB message objects.
 */
public interface JaxbObjectConverter {

    /**
     * Maps reading and key values to JAXB message objects.
     *
     ...
     * @throws Exception
     */
    Object convert(Map<ReadingId, MeasValue> readingValues, Map<String, MeasValue> keyValues) throws Exception;
}
