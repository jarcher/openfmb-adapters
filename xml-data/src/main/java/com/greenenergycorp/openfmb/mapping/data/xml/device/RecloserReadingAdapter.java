...
import com.greenenergycorp.openfmb.xml.RecloserReadingProfile;

import java.util.Map;

public class RecloserReadingAdapter implements JaxbObjectConverter {

    private final String messageId;
    private final Recloser deviceDescription;

    public RecloserReadingAdapter(String messageId, Recloser deviceDescription) {
