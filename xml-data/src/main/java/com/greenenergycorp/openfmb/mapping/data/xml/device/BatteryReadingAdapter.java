...
import com.greenenergycorp.openfmb.xml.BatteryReadingProfile;
import com.greenenergycorp.openfmb.xml.BatterySystem;
import com.greenenergycorp.openfmb.xml.Reading;

import java.util.Map;

public class BatteryReadingAdapter implements JaxbObjectConverter {

    private final String messageId;
    private final BatterySystem deviceDescription;

    public BatteryReadingAdapter(String messageId, BatterySystem deviceDescription) {
