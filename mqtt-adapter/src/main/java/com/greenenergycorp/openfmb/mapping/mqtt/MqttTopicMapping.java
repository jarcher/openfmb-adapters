...
/**
 * Maps a more generic OpenFMB message identifier to an MQTT topic.
 */
public interface MqttTopicMapping {

    /**
     * Translate message identifier to MQTT topic.
     *
     * @param messageType OpenFMB message type
     * @param messageId Logical device ID of message instance
     * @return MQTT topic
     */
    String toTopic(final String messageType, final String messageId);
}
