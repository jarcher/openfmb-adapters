...
import com.greenenergycorp.openfmb.mapping.model.DeviceValueBuffer;
...
/**
 * Manages the list of OpenFMB DeviceAdapters and the current values of data coming from the protocol adapters.
 *
...
public class DeviceUpdateManager implements DeviceObserver {
    ...
    /**
     * Update value buffers with data updates and push OpenFMB messages if there are any changes.
     *
    ...
    /**
     * Publish to the OpenFMB adapters with the current state of the value buffers.
     */
