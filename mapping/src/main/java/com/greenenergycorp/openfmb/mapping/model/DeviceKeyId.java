...
/**
 * ID of an OpenFMB key update (struct field) for a particular mapped device.
 */
public class DeviceKeyId {
     ...
     * @param key Name of the key, i.e. the field name of a OpenFMB struct.
     */
    ...
    /**
     * @return Name of the key, i.e. the field name of a OpenFMB struct.
     */
